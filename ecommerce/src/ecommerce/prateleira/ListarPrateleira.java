...
import ecommerce.gerente.dao.MGerente;
import ecommerce.prateleira.dao.MPrateleira;
import ecommerce.prateleira.dao.NovaPrateleira;
 ...
 * @author Thiago
 */
public class ListarPrateleira extends javax.swing.JFrame {
    PrateleiraDAO prateleiraDAO = new PrateleiraDAO();
    List<MPrateleira> listaPrateleira = null;
    public ListarPrateleira() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable11.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número", "Volume Atual", "Volume Máximo", "Capacidade %"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        NovaPrateleira nova = new NovaPrateleira();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       int id = listaPrateleira.get(row).getId();
       
       prateleiraDAO.deletarPrateleira(id);
       carregarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarPrateleira.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarPrateleira().setVisible(true);
            }
        });
    }
