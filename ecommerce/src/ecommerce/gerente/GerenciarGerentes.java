...
import ecommerce.gerente.dao.NovoGerente;
 ...
 * @author Thiago
 */
public class GerenciarGerentes extends javax.swing.JFrame {
    GerenteDAO gerenteDAO = new GerenteDAO();
   
    public GerenciarGerentes() {
        initComponents();
    ...
    public void carregarTabela(){
        ...
        modelo.setNumRows(0);
        List<MGerente> listaGerente = gerenteDAO.listar();
        MGerente gerente;
        for (int i = 0; i < listaGerente.size(); i++) {
            gerente = listaGerente.get(i);
            modelo.addRow(new Object[]{
                gerente.getNome(),gerente.getCpf(),gerente.getSenha()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerentes Cadastrados");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NovoGerente novo = new NovoGerente();
        novo.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        EscolherTipoFuncionario escolher = new EscolherTipoFuncionario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarGerentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerenciarGerentes().setVisible(true);
            }
        });
    }
